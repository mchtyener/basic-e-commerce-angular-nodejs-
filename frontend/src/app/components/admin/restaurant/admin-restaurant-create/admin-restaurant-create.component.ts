...
@Component({
  ...
  standalone: true,
  imports: [NgIf, ReactiveFormsModule, PhoneNumberInputComponent, FileUploadModule],
  templateUrl: './admin-restaurant-create.component.html',
  styleUrl: './admin-restaurant-create.component.scss'
})
export class AdminRestaurantCreateComponent {
